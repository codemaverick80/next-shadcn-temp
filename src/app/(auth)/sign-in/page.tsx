...
import UnderlineShape from "@/components/custom/shape/underline";
      ...
      <div className="mx-auto max-w-md space-y-6">
        <div className="space-y-2 text-center">
          <span className="relative inline-block">
            ...
            <UnderlineShape className="absolute -bottom-2 start-0 h-5.5 w-24 text-green-900 md:w-28 xl:-bottom-1.5 xl:w-36" />
          </span>
        </div>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <FcGoogle className="me-2 h-7 w-7 shrink-0" />
            Sign in with Google
          </Link>
          {/*<Link*/}
          ...
          <div className="flex justify-center">
            <Button asChild variant="ghost" className={cn("", "w-full")}>
